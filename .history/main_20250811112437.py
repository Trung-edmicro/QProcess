...
def main():
    ...
    print("1️⃣  Mode 1: Gemini OCR")
    print("2️⃣  Mode 2: Mathpix")
    print("0️⃣  Thoát")
    ...
    if mode == 1:
        # Mode 1: Vertex AI (chỉ ảnh)
        print(f"\n🤖 Sử dụng Mode 1: Vertex AI OCR")
        
        if num_files == 1:
            # Mode 1: Xử lý 1 ảnh đơn lẻ
            single_image_mode(file_paths[0])
        else:
            ...
            multiple_images_mode(file_paths, max_workers)
