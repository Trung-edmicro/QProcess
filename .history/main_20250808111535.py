...
def test_ocr_image(image_path):
    ...
    try:
        ...
        Trường hợp ảnh có dấu hiệu đặc biệt (như chữ ký, hình vẽ tay) thì không trả về ở kết quả.
        Với ảnh là đề thi thì cần loại bỏ các phần không liên quan như tiêu đề, hướng dẫn, số trang, mã đề.
