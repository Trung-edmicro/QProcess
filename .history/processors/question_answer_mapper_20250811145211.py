...
"""
    ...
    def process_single_file(self, input_file, output_file=None):
        ...
        try:
            ...
            # Tách nội dung thành câu hỏi và đáp án
            questions_content, answers_content = self._split_content_for_mapping(content)
            
            if not questions_content and not answers_content:
                print("❌ Không thể tách nội dung thành câu hỏi và đáp án")
                return None
            ...
            if not questions or not answers:
                print("❌ Không tìm thấy đủ câu hỏi hoặc đáp án để mapping")
                return None
