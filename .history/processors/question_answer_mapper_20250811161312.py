            ...
            if self.vertex_config.is_configured():
                ...
                self.model = GenerativeModel(
                    ...
                    generation_config=GenerationConfig(
                        ...
                        top_p=0.8,
                        top_k=20,
                        max_output_tokens=20000  # Tăng từ 8192 lên 16384 để xử lý content lớn hơn
                    )
                )
...
4. Trả về kết quả chỉ gồm nội dung xử lý được, không cần giải thích hay bình luận gì thêm.
