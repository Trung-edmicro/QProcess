...
- Tuyệt đối **không bịa nội dung**, không thêm từ ngữ nào khác (như kiểu "Dưới đây là nội dung đã được sắp xếp lại theo yêu cầu:"), không tự ý thêm lời giải nếu không có nguồn như "hướng dẫn giải" trong nội dung.
