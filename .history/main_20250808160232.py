...
def test_exam_processing():
    ...
    # Tìm file .md trong thư mục output
    ...
    if not md_files:
        print(f"❌ Không tìm thấy file .md nào trong: {output_folder}")
        return
    
    # Lấy file mới nhất
    latest_file = max(md_files, key=os.path.getmtime)
    print(f"📄 Đang test với file: {os.path.basename(latest_file)}")
    ...
    try:
        ...
        # Xử lý thêm template
        print("🔄 Đang xử lý thêm template lời giải...")
        ...
        new_filename = f"{base_name}_processed_{timestamp}.md"
