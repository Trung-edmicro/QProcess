...
def main():
    ...
    if num_images == 1:
        ...
        print("🔧 TỰ ĐỘNG CHỌN: Chế độ xử lý ảnh đơn lẻ")
        single_image_mode(image_paths[0])
        
    else:
        # Mode 3: Xử lý nhiều ảnh đồng thời (multiprocessing)
        print(f"🔧 TỰ ĐỘNG CHỌN: Chế độ xử lý đa tiến trình ({num_images} ảnh)")
